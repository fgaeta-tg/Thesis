...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.3\textwidth} 
        ...
        \source{Technogym Official Website}
        \label{tlab}
    \end{minipage}
    \hspace{1.3cm}
    \begin{minipage}[c]{0.3\textwidth}
...
To achieve this level of insight, the industry relies on three fundamental types of telemetry data that we wanted indeed to intercept for the project:
\begin{itemize}
...
\begin{figure}[H]
    ...
    \caption{OpenTelemetry Collector Architecture. Source: OpenTelemetry}
    \label{collector}
\end{figure}
...
While OpenTelemetry provides a robust framework for digital transformation, its implementation is not exempt from significant trade-offs. For a complex ecosystem like Technogym's, several inherent limitations must be addressed. 
...
\begin{figure}[H]
    ...
    \caption{Initial Database Management System Architecture. Source: chaossearch}
    \label{relational-db}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Data Warehouse Architecture. Source: chaossearch}
    \label{warehouse}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{DataLake Architecture. Source: chaossearch}
    \label{lake}
\end{figure}
...
The analogies among the three that make them interchangeable are:
\begin{itemize}
