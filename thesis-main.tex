...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.3\textwidth} 
        ...
        \caption{Technogym Lab. Source: Technogym}
        \label{tlab}
    \end{minipage}
    \hspace{1.3cm}
    \begin{minipage}[c]{0.3\textwidth}
        ...
        \caption{\textit{UNICA} multifunction machine. Source: Technogym}
        \label{unica}
    \end{minipage}
\end{figure}
