...
\cite{observability} To achieve this level of insight, the industry relies on three fundamental types of telemetry data that we wanted indeed to intercept for the project:
\begin{itemize}
...
\cite{OTelLimits} While OpenTelemetry provides a robust framework for digital transformation, its implementation is not exempt from significant trade-offs. For a complex ecosystem like Technogym's, several inherent limitations must be addressed. 
